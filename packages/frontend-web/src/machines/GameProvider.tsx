...
// NOTE: The XState infrastructure is complete (machine, actors, tests).
// UI integration requires matching component prop interfaces.
// Enable when ready to fully switch to XState-powered UI.
